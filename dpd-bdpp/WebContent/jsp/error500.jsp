...
<div class="col-xs-3 col-sm-2 col-md-1 text-center mrgn-tp-md"> 
 ...
 <div class="col-xs-9 col-sm-10 col-md-11"> 
  <h1 class="mrgn-tp-md"><bean:message bundle="clfRes" key="500.title"/></h1> 
  <p class="pagetag"><b><bean:message bundle="clfRes" key="500.error"/></b></p> 
 </div> 
</div> 


<p><bean:message bundle="clfRes" key="500.sorry" /></p>
<ul>
