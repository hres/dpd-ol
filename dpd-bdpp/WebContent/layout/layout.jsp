...
<!--<![endif]-->
<head>
<c:set var="applang"></c:set>
<% 
     java.util.HashMap paramsLang= new java.util.HashMap();
     paramsLang.put("lang", pageContext.getAttribute("lang") );
     request.setAttribute("paramsLang", paramsLang);
%>
<meta charset="utf-8">
	...
	<body vocab="http://schema.org/" typeof="WebPage">		
        ...
        <bean:define id="strUrl" value="&url=" />
        <!-- Write closure template -->
	<script type="text/javascript">
	...
	<div class="row"> 
	  <div class="col-md-12"> 
	   <h1 property="name" id="wb-cont"><bean:message name="titleKey" /></h1> 
	   <p class="pagetag"><bean:message key="label.shared.byline" /></p> 
	  </div> 
	 </div> 
            <!-- the main content -->
