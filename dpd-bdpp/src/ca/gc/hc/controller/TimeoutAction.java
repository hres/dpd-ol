...
public class TimeoutAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		request.setAttribute("lang", goctemplateclientbean.getTwoLetterCultureLanguage());
		...
		request.setAttribute("refTopStaticfile", strRefTopStaticFile);
		...
		request.setAttribute("defTopStaticFile", strDefTopStaticFile);
		...
		request.setAttribute("defFootStaticFile", strDefFootStaticFile);
